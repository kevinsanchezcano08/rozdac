<?php
    ...
    class userClass{
        ...
        /* Register */
        public function userRegister($user, $name, $fechaNac, $email, $password, $rol, $telefono){
            try{
                $modelo = new Conexion();
                ...
                $count = $stmt->rowCount();
                if($count<1){
                    $st = $db->prepare("INSERT INTO user(user,name,fechaNac,email,password,rol,telefono) VALUES (:user,:name,:fechaNac,:email,:password,:rol,:telefono)");
