...
<html lang="es">
    ...
    <body>
        ...
        <form action="" method="post" name="addnego" enctype="multipart/form-data">
            ...
            <input type="text" name="Id"  placeholder="Código" autocomplete="off" />

            <input type="text" name="name"  placeholder="Nombre" autocomplete="off" />

            <textarea name="descripcion" placeholder="Descripción" cols="30" rows="10"></textarea>

            <textarea name="mision" placeholder="Misión" cols="30" rows="10"></textarea>

            <textarea name="vision" placeholder="Visión" cols="30" rows="10"></textarea>

            <input type="file" name="fotoLogo"  placeholder="Nombre" autocomplete="off" />
